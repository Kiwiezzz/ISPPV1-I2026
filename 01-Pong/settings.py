...
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_1, "one")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_2, "two")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_3, "three")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_4, "four")
